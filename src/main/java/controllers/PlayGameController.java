...
public final class PlayGameController extends BackHomeController {
    ...
    /**
     * The handler for the click event generated by the 'rbtStandard' button.
     * @param event event caused by select rbtStandard button
     */
    @FXML
    public void rbtStandard(final ActionEvent event) {
        event.consume();
        check();
        this.loadModality(Modality.STANDARD);
    }
    /**
     * The handler for the click event generated by the 'rbtOnevsOne' button.
     * @param event event caused by select rbtOnevsOne button
     */
    @FXML
    public void rbtOnevsOne(final ActionEvent event) {
        event.consume();
        check();
        this.loadModality(Modality.ONE_VS_ONE);
    }
    /**
     * The handler for the click event generated by the 'rbtBtt' button.
     * @param event event caused by select rbtBtt button
     */
    @FXML
    public void rbtBtt(final ActionEvent event) {
        event.consume();
        check();
        this.loadModality(Modality.BTT);
    }
    /**
     * The handler for the click event generated by the 'rbtEasy' button.
     * @param event event caused by select rbtEasy button
     */
    @FXML
    public void rbtEasy(final ActionEvent event) {
        event.consume();
        checkDiff();
    ...
    /**
     * The handler for the click event generated by the 'rbtMedium' button.
     * @param event event caused by select rbtMedium button
     */
    @FXML
    public void rbtMedium(final ActionEvent event) {
        event.consume();
        checkDiff();
    ...
    /**
     * The handler for the click event generated by the 'rbtHard' button.
     * @param event event caused by select rbtHard button
     */
    @FXML
    public void rbtHard(final ActionEvent event) {
        event.consume();
        checkDiff();
    ...
    /**
     * The handler for the click event generated by the 'rbtPersonalized' button.
     * @param event event caused by select rbtPersonalized button
     */
    @FXML
    public void rbtPersonalized(final ActionEvent event) {
        event.consume();
        checkDiff();
    ...
    /**
     * The handler for the click event generated by the 'btPlay' button.
     * @param event 
     */
    @FXML
    public void btPlay(final ActionEvent event) {
        event.consume();
